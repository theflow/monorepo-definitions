const monorepoDefinitions = {
  ...
  'bugsnag': [
    ...
    '@bugsnag/plugin-console-breadcrums',
    ...
    '@bugsnag/plugin-interaction-breadcrums',
    '@bugsnag/plugin-intercept',
    '@bugsnag/plugin-koa',
    '@bugsnag/plugin-navigation-breadcrumbs',
    '@bugsnag/plugin-network-breadcrums',
    ...
    '@bugsnag/plugin-react-native-app-state-breadcrumb',
